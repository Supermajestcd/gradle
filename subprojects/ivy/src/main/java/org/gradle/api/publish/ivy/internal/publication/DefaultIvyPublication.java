...
public class DefaultIvyPublication implements IvyPublicationInternal {
     ...
     */
    private boolean defaultShouldExtend(SoftwareComponentVariant variant) {
    ...
    private boolean isJavaRuntimeVariant(String variantName) {
        return RUNTIME_VARIANT.equals(variantName) || RUNTIME_ELEMENTS_VARIANT.equals(variantName);
    }

    private boolean isJavaApiVariant(String variantName) {
    ...
    private String confMappingFor(SoftwareComponentVariant variant, ModuleDependency dependency) {
        String conf = mapVariantNameToIvyConfiguration(variant.getName());
     ...
     */
    private String mapVariantNameToIvyConfiguration(String variantName) {
